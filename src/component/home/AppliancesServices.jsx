...
const AppliancesServices = () => {
  const allServices = [
    { id: 1, name: 'AC REPAIR', image: assets.acRoom_Repair },
    { id: 2, name: 'CCTV REPAIR', image: assets.cctv_home_repair },
    { id: 3, name: 'CHIMNEY REPAIR', image: assets.chimneyHouse_Repair },
    { id: 4, name: 'DEEP FREEZER REPAIR', image:  assets.deepfridge_repair},
    { id: 5, name: 'DISHWASHER REPAIR', image: assets.dishwasher_repair },
    { id: 6, name: 'REFRIGERATOR REPAIR', image:  assets.fridge_repair},
    { id: 7, name: 'ICE MAKER REPAIR', image:  assets.ice_maker_Repair},
    { id: 8, name: 'INVERTER REPAIR', image:  assets.inverter_repair},
    { id: 9, name: "MICROWAVE OVEN REPAIR" ,image: assets.microwave_repair},
    { id: 10, name: "MIXER GRINDER REPAIR" ,image: assets.mixer_grinder_repair},
    { id: 11, name: "LED REPAIR" ,image: assets.led_repair},
    { id: 12, name: "OVEN HEATER REPAIR" ,image: assets.oven_heater_repair}
  ];
