            ...
            >
              ...
              <div className="text-center px-4 w-full">
                ...
                <BookNowButton
                  ...
                  className="w-full max-w-[120px] bg-[#ff8c00] text-white text-[10px] md:text-xs font-bold py-2 rounded-md shadow-[0_3px_0_#cc7000] active:translate-y-[1px] active:shadow-none transition-all hover:bg-[#e67e22]"
                />
              </div>
            </div>
          ))}
