        ...
        <div className="relative bg-white rounded-[1.4rem] overflow-hidden flex flex-col h-full">
          ...
          >
            ...
            <div className="mt-auto flex gap-2 w-full">
              <button 
                onClick={() => onBookNow && onBookNow(title)}
                className="flex-1 bg-gradient-to-r from-green-400 to-cyan-500 text-white font-bold py-2 rounded-lg text-[9px] uppercase tracking-tighter shadow-md hover:-translate-y-0.5 transition-all"
              >
                Book Now
              </button>
              <button 
                onClick={() => onEnquiryClick && onEnquiryClick(title)}
                className="flex-1 bg-gradient-to-r from-orange-400 to-rose-500 text-white font-bold py-2 rounded-lg text-[9px] uppercase tracking-tighter shadow-md hover:-translate-y-0.5 transition-all"
              >
                Enquiry
              </button>
            </div>
