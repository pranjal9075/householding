...
const HandymanServices = () => {
  const allServices = [
    { id: 1, name: 'CHAIR REPAIR', image: assets.chair_repair_service },
    { id: 2, name: 'FURNITURE INSTALLATION ', image: assets.furniture_installation },
    { id: 3, name: 'CARPENTRY REPAIR', image: assets.carpentary },
    { id: 4, name: 'PLUMBER REPAIR', image:  assets.plumber_services},
    { id: 5, name: 'ELECTRICAL REPAIR', image: assets.electrician_service },
    { id: 6, name: 'WARDROBE REPAIR', image:  assets.wardrobe_service},
    { id: 7, name: 'FURNITURE REPAIR', image:  assets.furniture_service},
    { id: 8, name: 'SOFA REPAIR', image:  assets.sofa_service},
  ];
