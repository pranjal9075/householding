...
//                                         <button type="button" className="flex-1 py-2 bg-white/5 border border-white/10 rounded-xl text-[9px] font-bold text-gray-400 hover:text-white transition-all uppercase">Google</button>
//                                         <button type="button" className="flex-1 py-2 bg-white/5 border border-white/10 rounded-xl text-[9px] font-bold text-gray-400 hover:text-white transition-all uppercase">Github</button>
//                                     </div>
//                                 </div>
//                             </>
//                         ) : (
